...
function normalizePathForComparison(input) {
	...
	try {
		normalized = fs$1.realpathSync.native(resolved);
	} catch {}
...
//#endregion
export { appendFileWithinRoot as $, supportsMemoryMultimodalEmbeddings as A, normalizeAtHashSlug as At, resolveWindowsSpawnProgram as B, isFileMissingError as C, resolveAgentWorkspaceDir as Ct, getMemoryMultimodalExtensions as D, resolveSessionAgentId as Dt, classifyMemoryMultimodalPath as E, resolveRunModelFallbacksOverride as Et, resolveSessionTranscriptPath as F, resolveAgentModelPrimaryValue as Ft, isAudioFileName as G, extensionForMime as H, resolveSessionTranscriptPathInDir as I, toAgentModelListLike as It, normalizeMimeType as J, isGifMedia as K, resolveSessionTranscriptsDirForAgent as L, resolveDefaultSessionStorePath as M, normalizeStringEntries as Mt, resolveSessionFilePath as N, normalizeStringEntriesLower as Nt, isMemoryMultimodalEnabled as O, resolveSessionAgentIds as Ot, resolveSessionFilePathOptions as P, resolveAgentModelFallbackValues as Pt, SafeOpenError as Q, resolveStorePath as R, splitTextToUtf8ByteLimit as S, resolveAgentSkillsFilter as St, buildCaseInsensitiveExtensionGlob as T, resolveEffectiveModelFallbacks as Tt, getFileExtension as U, detectMime as V, imageMimeFromFormat as W, maxBytesForKind as X, MAX_IMAGE_BYTES as Y, mediaKindFromMime as Z, remapChunkLines as _, resolveAgentConfig as _t, listSessionFilesForAgent as a, writeFileFromPathWithinRoot as at, estimateStructuredEmbeddingInputBytes as b, resolveAgentIdByWorkspacePath as bt, buildMultimodalChunkForIndexing as c, assertNoPathAliasEscape as ct, ensureDir as d, redactToolDetail as dt, copyFileWithinRoot as et, hashText as f, compileSafeRegex as ft, parseEmbedding as g, listAgentIds as gt, normalizeExtraMemoryPaths as h, hasConfiguredModelFallbacks as ht, buildSessionEntry as i, readLocalFileSafely as it, resolveAgentsDirFromSessionStorePath as j, normalizeHyphenSlug as jt, normalizeMemoryMultimodalSettings as k, normalizeSkillFilter as kt, chunkMarkdown as l, getDefaultRedactPatterns as lt, listMemoryFiles as m, runTasksWithConcurrency as mt, isQueryStopWordToken as n, openFileWithinRoot as nt, sessionPathForFile as o, writeFileWithinRoot as ot, isMemoryPath as p, testRegexWithBoundedInput as pt, kindFromMime as q, requireNodeSqlite as r, readFileWithinRoot as rt, buildFileEntry as s, PATH_ALIAS_POLICIES as st, extractKeywords as t, createRootScopedReadFile as tt, cosineSimilarity as u, redactSensitiveText as ut, runWithConcurrency as v, resolveAgentDir as vt, statRegularFile as w, resolveDefaultAgentId as wt, estimateUtf8Bytes as x, resolveAgentModelFallbacksOverride as xt, hasNonTextEmbeddingParts as y, resolveAgentEffectiveModelPrimary as yt, materializeWindowsSpawnProgram as z };
