...
import { $n as parseTtsDirectives, $r as isGatewayMessageChannel, $t as normalizeReplyPayload, Ai as buildWorkspaceSkillSnapshot, Ar as getChannelPlugin, Bi as DEFAULT_MODEL, Bt as registerAgentRunContext, Cr as evaluateSessionFreshness, Ct as runEmbeddedPiAgent, Dr as mergeSessionEntry, Er as resolveSessionResetType, Fi as formatXHighModelHint, Ft as resolveAgentTimeoutMs, Gn as isSilentReplyText, Gt as AGENT_LANE_SUBAGENT, Ht as resolveAcpAgentPolicyError, Ii as normalizeThinkLevel, It as formatAgentInternalEventsForPrompt, Jt as hasNonzeroUsage, Kt as applyModelOverrideToSessionEntry, Li as normalizeVerboseLevel, Lt as normalizeSpawnedRunMetadata, Mi as ensureAuthProfileStore, Ni as formatCliCommand, Nn as getAcpSessionManager, On as clearBootstrapSnapshotOnSessionRollover, Or as setSessionRuntimeModel, Pi as formatThinkingLevels, Pn as toAcpRuntimeError, Qn as textToSpeech, Qr as isDeliverableMessageChannel, Ri as supportsXHighThinking, Rt as clearAgentRunContext, Si as formatErrorMessage, Sn as resolveMessageChannelSelection, Sr as resolveSessionKey, Tn as FailoverError, Tr as resolveSessionResetPolicy, Tt as resolveBootstrapWarningSignaturesSeen, Ut as resolveAcpDispatchPolicyError, Vi as DEFAULT_PROVIDER, Vt as resolveAcpSessionCwd, W as isDangerousNameMatchingEnabled, Wn as isSilentReplyPrefixText, Wt as AGENT_LANE_NESTED, Yt as resolveContextTokensForModel, Zn as resolveTtsConfig, Zr as INTERNAL_MESSAGE_CHANNEL, _n as deliverOutboundPayloads, _r as loadSessionStore, a as setRuntimeConfigSnapshot, ar as buildProviderRegistry, bn as normalizeOutboundPayloadsForJson, br as updateSessionStore, c as modelKey, d as resolveConfiguredModelRef, dn as resolveDiscordOwnerAccess, dt as runCliAgent, ei as isInternalMessageChannel, f as resolveDefaultModelForAgent, fn as formatDiscordUserTag, ft as clearSessionAuthProfileOverride, gn as buildOutboundSessionContext, gr as emitSessionTranscriptUpdate, gt as getSkillsSnapshotVersion, h as resolveCommandSecretRefsViaGateway, hr as resolveSessionTranscriptFile, ht as getRemoteSkillEligibility, i as readConfigFileSnapshotForWrite, jr as normalizeChannelId, kr as resolveExplicitAgentSessionKey, l as normalizeModelRef, ln as resolveOutboundTarget, lr as runCapability, lt as getCliSessionId, m as getAgentRuntimeCommandSecretTargetIds, mr as loadModelCatalog, ni as resolveMessageChannel, o as buildAllowedModelSet, or as createMediaAttachmentCache, p as resolveThinkingDefault, pt as applyVerboseOverride, qt as deriveSessionTotalTokens, r as loadConfig, s as isCliProvider, sn as resolveAgentRoute, sr as normalizeMediaAttachments, ti as normalizeMessageChannel, u as normalizeProviderId, un as resolveSessionDeliveryTarget, ut as setCliSessionId, vn as formatOutboundPayloadLog, vt as resolveSendPolicy, wn as runWithModelFallback, wr as resolveChannelResetConfig, wt as prepareSessionManagerForRun, xr as normalizeAccountId, yn as normalizeOutboundPayloads, z as formatMention, zt as emitAgentEvent } from "./discord-CcCLMjHw.js";
...
import { R as resolveStorePath, Tt as ensureAgentWorkspace, at as listAgentIds, dt as resolveAgentWorkspaceDir, ht as resolveSessionAgentId, pt as resolveEffectiveModelFallbacks, st as resolveAgentDir, ut as resolveAgentSkillsFilter } from "./query-expansion-Dpf_vNBe.js";
import { A as shouldLogVerbose, D as logVerbose, q as resolvePreferredOpenClawTmpDir } from "./utils-BBQx0yHF.js";
import "./paths-DO_VTrpA.js";
import { a as createSubsystemLogger, l as defaultRuntime } from "./logger-DLTnPbcB.js";
...
function loadWhatsAppSenderRuntime() {
	whatsappSenderRuntimePromise ??= import("./deps-send-whatsapp.runtime-CoXqZUch.js");
	return whatsappSenderRuntimePromise;
}
function loadTelegramSenderRuntime() {
	telegramSenderRuntimePromise ??= import("./deps-send-telegram.runtime-2dxRAnwr.js");
	return telegramSenderRuntimePromise;
}
function loadDiscordSenderRuntime() {
	discordSenderRuntimePromise ??= import("./deps-send-discord.runtime-DPJu4mDK.js");
	return discordSenderRuntimePromise;
}
function loadSlackSenderRuntime() {
	slackSenderRuntimePromise ??= import("./deps-send-slack.runtime-IISdLNuH.js");
	return slackSenderRuntimePromise;
}
function loadSignalSenderRuntime() {
	signalSenderRuntimePromise ??= import("./deps-send-signal.runtime-fo24FRub.js");
	return signalSenderRuntimePromise;
}
function loadIMessageSenderRuntime() {
	imessageSenderRuntimePromise ??= import("./deps-send-imessage.runtime-COnRVjrV.js");
