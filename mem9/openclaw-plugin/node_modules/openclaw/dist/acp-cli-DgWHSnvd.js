...
import { Bt as resolveGatewayConnectionAuth, Ev as listThinkingLevels, Gs as buildGatewayConnectionDetails, Hp as GATEWAY_CLIENT_NAMES, Vp as GATEWAY_CLIENT_MODES, ic as GatewayClient, jg as loadConfig, sg as isKnownCoreToolId } from "./auth-profiles-DRjqKE3G.js";
...
import { M as resolveWindowsSpawnProgram, j as materializeWindowsSpawnProgram } from "./query-expansion-E78fX0en.js";
...
import { i as omitEnvKeysCaseInsensitive, n as listKnownProviderAuthEnvVarNames } from "./provider-env-vars-eiXtKwfg.js";
import { t as DANGEROUS_ACP_TOOLS } from "./dangerous-tools-BQrJ_PWn.js";
...
async function createAcpClient(opts = {}) {
	...
	const { getActiveSkillEnvKeys } = await import("./env-overrides.runtime-BBhdpG1n.js");
