...
import { $i as normalizeAccountId, An as applyModelOverrideToSessionEntry, As as DEFAULT_MODEL, Bo as resolveMessageChannel, C as resolveThinkingDefault, Ci as buildProviderRegistry, Cn as emitAgentEvent, Ct as formatMention, Di as runCapability, Dn as resolveAcpDispatchPolicyError, En as resolveAcpAgentPolicyError, Er as resolveMessageChannelSelection, Es as ensureAuthProfileStore, Fo as INTERNAL_MESSAGE_CHANNEL, Gi as resolveSessionTranscriptFile, Gt as getRemoteSkillEligibility, Ht as applyVerboseOverride, Io as isDeliverableMessageChannel, J as isDangerousNameMatchingEnabled, Ki as emitSessionTranscriptUpdate, Ln as normalizeReplyPayload, Lo as isGatewayMessageChannel, Lt as getCliSessionId, Mn as hasNonzeroUsage, Nn as resolveContextTokensForModel, On as AGENT_LANE_NESTED, Or as runWithModelFallback, Pi as loadModelCatalog, Pr as clearBootstrapSnapshotOnSessionRollover, Qt as getSkillsSnapshotVersion, Ro as isInternalMessageChannel, Rt as setCliSessionId, S as resolveDefaultModelForAgent, Sn as clearAgentRunContext, Sr as normalizeOutboundPayloadsForJson, T as resolveCommandSecretRefsViaGateway, Ti as normalizeMediaAttachments, Tn as resolveAcpSessionCwd, Vr as getAcpSessionManager, Vt as clearSessionAuthProfileOverride, Xi as updateSessionStore, Zn as resolveAgentRoute, _ as isCliProvider, a as readConfigFileSnapshotForWrite, aa as mergeSessionEntry, b as normalizeProviderId, bn as formatAgentInternalEventsForPrompt, br as formatOutboundPayloadLog, ca as getChannelPlugin, cn as prepareSessionManagerForRun, cr as resolveSessionDeliveryTarget, cs as formatErrorMessage, dr as resolveDiscordOwnerAccess, ea as resolveSessionKey, fr as formatDiscordUserTag, g as buildAllowedModelSet, gi as parseTtsDirectives, gs as buildWorkspaceSkillSnapshot, hi as textToSpeech, i as loadConfig, ia as resolveSessionResetType, ii as isSilentReplyText, jn as deriveSessionTotalTokens, js as DEFAULT_PROVIDER, kn as AGENT_LANE_SUBAGENT, kr as FailoverError, la as normalizeChannelId, ln as resolveBootstrapWarningSignaturesSeen, mi as resolveTtsConfig, na as resolveChannelResetConfig, nn as resolveSendPolicy, o as setRuntimeConfigSnapshot, oa as setSessionRuntimeModel, qi as loadSessionStore, ra as resolveSessionResetPolicy, ri as isSilentReplyPrefixText, sa as resolveExplicitAgentSessionKey, sn as runEmbeddedPiAgent, sr as resolveOutboundTarget, ta as evaluateSessionFreshness, v as modelKey, vr as buildOutboundSessionContext, w as getAgentRuntimeCommandSecretTargetIds, wi as createMediaAttachmentCache, wn as registerAgentRunContext, x as resolveConfiguredModelRef, xn as normalizeSpawnedRunMetadata, xr as normalizeOutboundPayloads, y as normalizeModelRef, yn as resolveAgentTimeoutMs, yr as deliverOutboundPayloads, zo as normalizeMessageChannel, zt as runCliAgent } from "./thread-bindings-SYAnWHuW.js";
...
import { a as defaultRuntime, d as logVerbose, m as shouldLogVerbose, t as createSubsystemLogger } from "./subsystem-7GlwMGJM.js";
import "./utils-B2utBG_m.js";
import "./fetch-CtE9nADJ.js";
import "./exec-CbLkwGIT.js";
import { f as supportsXHighThinking, l as normalizeVerboseLevel, n as formatXHighModelHint, s as normalizeThinkLevel, t as formatThinkingLevels } from "./thinking-D7ZEZ42s.js";
import { At as ensureAgentWorkspace, R as resolveStorePath, bt as resolveSessionAgentId, ft as resolveAgentDir, gt as resolveAgentWorkspaceDir, ht as resolveAgentSkillsFilter, ut as listAgentIds, vt as resolveEffectiveModelFallbacks } from "./query-expansion-DrxgDYz1.js";
...
import { c as toAcpRuntimeError } from "./registry-B_tf98QY.js";
...
function loadWhatsAppSenderRuntime() {
	whatsappSenderRuntimePromise ??= import("./deps-send-whatsapp.runtime-9nizYskw.js");
	return whatsappSenderRuntimePromise;
}
function loadTelegramSenderRuntime() {
	telegramSenderRuntimePromise ??= import("./deps-send-telegram.runtime-vqz1qWQX.js");
	return telegramSenderRuntimePromise;
}
function loadDiscordSenderRuntime() {
	discordSenderRuntimePromise ??= import("./deps-send-discord.runtime-DEEtGcjn.js");
	return discordSenderRuntimePromise;
}
function loadSlackSenderRuntime() {
	slackSenderRuntimePromise ??= import("./deps-send-slack.runtime-BBdeW-kw.js");
	return slackSenderRuntimePromise;
}
function loadSignalSenderRuntime() {
	signalSenderRuntimePromise ??= import("./deps-send-signal.runtime-ChmwrWTw.js");
	return signalSenderRuntimePromise;
}
function loadIMessageSenderRuntime() {
	imessageSenderRuntimePromise ??= import("./deps-send-imessage.runtime-BbSlrtvY.js");
