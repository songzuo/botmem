...
import { Cm as GATEWAY_CLIENT_MODES, Eg as isKnownCoreToolId, Es as buildGatewayConnectionDetails, Wt as resolveGatewayConnectionAuth, u_ as loadConfig, uv as VERSION, wm as GATEWAY_CLIENT_NAMES, zs as GatewayClient, zv as listThinkingLevels } from "./reply-Bm8VrLQh.js";
...
import { M as resolveWindowsSpawnProgram, j as materializeWindowsSpawnProgram } from "./query-expansion-CxfqvqXX.js";
...
import { i as omitEnvKeysCaseInsensitive, n as listKnownProviderAuthEnvVarNames } from "./provider-env-vars-LOwkO_0R.js";
import { t as DANGEROUS_ACP_TOOLS } from "./dangerous-tools-BmJSxtj-.js";
...
async function createAcpClient(opts = {}) {
	...
	const { getActiveSkillEnvKeys } = await import("./env-overrides.runtime-Fa_6ICYc.js");
