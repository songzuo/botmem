...
import { Et as resolveSessionAgentId, It as ensureAgentWorkspace, R as resolveStorePath, St as resolveAgentWorkspaceDir, fn as normalizeAgentId, gt as listAgentIds, mn as resolveAgentIdFromSessionKey, pn as normalizeMainKey, vt as resolveAgentDir, wt as resolveEffectiveModelFallbacks, xt as resolveAgentSkillsFilter } from "./query-expansion-C6UNkw7W.js";
import "./paths-CzCvxHkV.js";
import { B as shouldLogVerbose, M as defaultRuntime, O as createSubsystemLogger, R as logVerbose, Z as resolvePreferredOpenClawTmpDir } from "./logger-Cmh2bFJD.js";
import { $t as resolveMessageChannelSelection, At as normalizeReplyPayload, B as applyVerboseOverride, Bn as createMediaAttachmentCache, Bt as resolveOutboundTarget, Ci as supportsXHighThinking, Ct as applyModelOverrideToSessionEntry, Dn as isSilentReplyText, En as isSilentReplyPrefixText, Et as resolveContextTokensForModel, Fr as isInternalMessageChannel, H as formatMention, Ht as resolveDiscordOwnerAccess, I as getCliSessionId, Ir as normalizeMessageChannel, Jn as loadModelCatalog, Jt as deliverOutboundPayloads, K as getRemoteSkillEligibility, L as setCliSessionId, Lr as resolveMessageChannel, Mn as textToSpeech, Mr as INTERNAL_MESSAGE_CHANNEL, Nn as parseTtsDirectives, Nr as isDeliverableMessageChannel, Oi as DEFAULT_MODEL, Pr as isGatewayMessageChannel, R as runCliAgent, Rt as resolveAgentRoute, Si as normalizeVerboseLevel, St as AGENT_LANE_SUBAGENT, Tt as hasNonzeroUsage, Un as runCapability, Ut as formatDiscordUserTag, Vn as normalizeMediaAttachments, Vt as resolveSessionDeliveryTarget, Xn as emitSessionTranscriptUpdate, Xt as normalizeOutboundPayloads, Y as resolveSendPolicy, Yn as resolveSessionTranscriptFile, Yt as formatOutboundPayloadLog, Zn as loadSessionStore, Zt as normalizeOutboundPayloadsForJson, _i as ensureAuthProfileStore, _t as registerAgentRunContext, a as normalizeProviderId, an as clearBootstrapSnapshotOnSessionRollover, ar as resolveChannelResetConfig, b as isDangerousNameMatchingEnabled, bi as formatXHighModelHint, bt as resolveAcpDispatchPolicyError, c as resolveThinkingDefault, cr as mergeSessionEntry, di as buildWorkspaceSkillSnapshot, dn as toAcpRuntimeError, dr as getChannelPlugin, et as runEmbeddedPiAgent, fr as normalizeChannelId, ft as resolveAgentTimeoutMs, gt as emitAgentEvent, hi as setRuntimeConfigSnapshot, ht as clearAgentRunContext, i as normalizeModelRef, ir as evaluateSessionFreshness, jn as resolveTtsConfig, ki as DEFAULT_PROVIDER, l as getAgentRuntimeCommandSecretTargetIds, lr as setSessionRuntimeModel, mi as readConfigFileSnapshotForWrite, mt as normalizeSpawnedRunMetadata, n as isCliProvider, nn as FailoverError, nr as normalizeAccountId, nt as resolveBootstrapWarningSignaturesSeen, o as resolveConfiguredModelRef, or as resolveSessionResetPolicy, pi as loadConfig, pt as formatAgentInternalEventsForPrompt, q as getSkillsSnapshotVersion, qt as buildOutboundSessionContext, r as modelKey, ri as formatErrorMessage, rr as resolveSessionKey, s as resolveDefaultModelForAgent, sr as resolveSessionResetType, t as buildAllowedModelSet, tn as runWithModelFallback, tr as updateSessionStore, tt as prepareSessionManagerForRun, u as resolveCommandSecretRefsViaGateway, un as getAcpSessionManager, ur as resolveExplicitAgentSessionKey, vi as formatCliCommand, vt as resolveAcpSessionCwd, wt as deriveSessionTotalTokens, xi as normalizeThinkLevel, xt as AGENT_LANE_NESTED, yi as formatThinkingLevels, yt as resolveAcpAgentPolicyError, z as clearSessionAuthProfileOverride, zn as buildProviderRegistry } from "./model-selection-46xMp11W.js";
...
function loadWhatsAppSenderRuntime() {
	whatsappSenderRuntimePromise ??= import("./deps-send-whatsapp.runtime-CY9etPdy.js");
	return whatsappSenderRuntimePromise;
}
function loadTelegramSenderRuntime() {
	telegramSenderRuntimePromise ??= import("./deps-send-telegram.runtime-CaPCFS4r.js");
	return telegramSenderRuntimePromise;
}
function loadDiscordSenderRuntime() {
	discordSenderRuntimePromise ??= import("./deps-send-discord.runtime-DMzmv0LH.js");
	return discordSenderRuntimePromise;
}
function loadSlackSenderRuntime() {
	slackSenderRuntimePromise ??= import("./deps-send-slack.runtime-XkQunMpC.js");
	return slackSenderRuntimePromise;
}
function loadSignalSenderRuntime() {
	signalSenderRuntimePromise ??= import("./deps-send-signal.runtime-BczUED0D.js");
	return signalSenderRuntimePromise;
}
function loadIMessageSenderRuntime() {
	imessageSenderRuntimePromise ??= import("./deps-send-imessage.runtime-DgclkhYy.js");
