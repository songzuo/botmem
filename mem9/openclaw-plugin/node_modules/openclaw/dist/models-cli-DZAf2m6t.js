...
import { n as isRich$1, r as theme, t as colorize } from "./theme-CipOb_We.js";
import { S as shortenHomePath } from "./utils-DwZbjiC4.js";
import { $ as resolveCommandSecretRefsViaGateway, A as normalizeProviderId, B as resolvePluginProviders, C as findNormalizedProviderValue, D as modelKey, Dt as openUrl, Ev as resolveOpenClawAgentDir, F as resolveDefaultModelForAgent, Fv as DEFAULT_PROVIDER, Gd as resolveModelWithRegistry, Jd as discoverAuthStorage, K as withProgressTotals, L as resolveModelRefFromString, Ov as resolveAuthProfileDisplayLabel, P as resolveConfiguredModelRef, Pv as DEFAULT_MODEL, S as buildModelAliasIndex, Si as resolveUsageProviderId, Tv as resolveAuthStorePathForDisplay, Ug as resolveSecretRefString, X as getModelsCommandSecretTargetIds, Yd as discoverModels, _f as resolveApiKeyForProvider, _v as listProfilesForProvider, bf as resolveUsableCustomProviderApiKey, bv as ensureAuthProfileStore, c as buildAuthHealthSummary, ep as resolveAuthProfileEligibility, ff as loadModelCatalog, g_ as setRuntimeConfigSnapshot, gf as hasUsableCustomProviderApiKey, hf as getCustomProviderApiKey, j as parseModelRef, l as formatRemainingShort, l_ as createConfigIO, m_ as readConfigFileSnapshotForWrite, mf as shouldSuppressBuiltInModel, mv as shouldEnableShellEnvFallback, np as resolveProfileUnusableUntilForDisplay, o as maskApiKey, pv as getShellEnvAppliedKeys, qa as describeFailoverError, qf as isNonSecretApiKeyMarker, s as DEFAULT_OAUTH_WARN_MS, tp as resolveAuthProfileOrder, u_ as loadConfig, vf as resolveAwsSdkEnvVarName, vv as setAuthProfileOrder, w_ as parseDurationMs, xi as formatUsageWindowSummary, yf as resolveEnvApiKey, yi as loadProviderUsageSummary, yr as runEmbeddedPiAgent, yv as upsertAuthProfile } from "./reply-Bm8VrLQh.js";
import { F as toAgentModelListLike, N as resolveAgentModelFallbackValues, P as resolveAgentModelPrimaryValue, a as resolveAgentDir, d as resolveAgentWorkspaceDir, f as resolveDefaultAgentId, j as resolveDefaultAgentWorkspaceDir, l as resolveAgentModelFallbacksOverride, s as resolveAgentExplicitModelPrimary } from "./agent-scope-DvYJ0Ktc.js";
...
import { a as resolveSessionTranscriptPath, c as resolveSessionTranscriptsDirForAgent } from "./paths-DBVuZIGo.js";
...
import { n as runCommandWithRuntime, t as resolveOptionFromCommand } from "./cli-utils-BSURvrmb.js";
...
import { n as redactSecrets } from "./format-BPo-2-uv.js";
...
import { n as validateAnthropicSetupToken } from "./auth-token-Dlh0GKMD.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./auth-profiles.runtime-BoisBr19.js");
	const { ensureOpenClawModelsJson } = await import("./reply-Bm8VrLQh.js").then((n) => n.pf);
