import { p as defaultRuntime, t as createSubsystemLogger } from "./subsystem-D2xHvZZd.js";
import { $ as resolveCommandSecretRefsViaGateway, $p as resolveExplicitAgentSessionKey, A as normalizeProviderId, Aa as normalizeOutboundPayloadsForJson, D as modelKey, Dr as resolveBootstrapWarningSignaturesSeen, Ea as deliverOutboundPayloads, F as resolveDefaultModelForAgent, Fv as DEFAULT_PROVIDER, Ga as runWithModelFallback, Gp as resolveChannelResetConfig, Gv as normalizeVerboseLevel, Ha as resolveMessageChannelSelection, Ii as resolveContextTokensForModel, Iv as formatThinkingLevels, J as getAgentRuntimeCommandSecretTargetIds, Jp as mergeSessionEntry, Ka as FailoverError, Kp as resolveSessionResetPolicy, Lv as formatXHighModelHint, O as normalizeModelRef, Oa as formatOutboundPayloadLog, Op as normalizeAccountId, P as resolveConfiguredModelRef, Pv as DEFAULT_MODEL, Qu as toAcpRuntimeError, Sd as isSilentReplyText, T as isCliProvider, Ta as buildOutboundSessionContext, Tu as clearBootstrapSnapshotOnSessionRollover, Up as resolveSessionKey, Uv as normalizeThinkLevel, Vi as normalizeReplyPayload, Wp as evaluateSessionFreshness, Xp as setSessionRuntimeModel, Zu as getAcpSessionManager, _a as resolveSessionDeliveryTarget, _m as isInternalMessageChannel, a as runCliAgent, ai as emitAgentEvent, bm as resolveMessageChannel, bp as updateSessionStore, br as prepareSessionManagerForRun, bv as ensureAuthProfileStore, ci as registerAgentRunContext, di as resolveAcpDispatchPolicyError, dp as resolveSessionTranscriptFile, ei as resolveAgentTimeoutMs, ff as loadModelCatalog, fr as resolveSendPolicy, g_ as setRuntimeConfigSnapshot, ga as resolveOutboundTarget, gm as isGatewayMessageChannel, gp as loadSessionStore, hi as AGENT_LANE_SUBAGENT, hn as clearSessionAuthProfileOverride, i as setCliSessionId, ii as clearAgentRunContext, ka as normalizeOutboundPayloads, li as resolveAcpSessionCwd, m_ as readConfigFileSnapshotForWrite, mi as AGENT_LANE_NESTED, mm as isDeliverableMessageChannel, mp as emitSessionTranscriptUpdate, ni as normalizeSpawnedRunMetadata, pm as INTERNAL_MESSAGE_CHANNEL, pn as getSkillsSnapshotVersion, qp as resolveSessionResetType, qt as getRemoteSkillEligibility, qv as supportsXHighThinking, r as getCliSessionId, ti as formatAgentInternalEventsForPrompt, u as applyVerboseOverride, u_ as loadConfig, ui as resolveAcpAgentPolicyError, vi as applyModelOverrideToSessionEntry, x as buildAllowedModelSet, xd as isSilentReplyPrefixText, ym as normalizeMessageChannel, yr as runEmbeddedPiAgent, z as resolveThinkingDefault } from "./reply-Bm8VrLQh.js";
import { D as ensureAgentWorkspace, a as resolveAgentDir, d as resolveAgentWorkspaceDir, h as resolveSessionAgentId, p as resolveEffectiveModelFallbacks, r as listAgentIds, u as resolveAgentSkillsFilter } from "./agent-scope-DvYJ0Ktc.js";
import { c as normalizeAgentId, l as normalizeMainKey, u as resolveAgentIdFromSessionKey } from "./session-key-BFl8Ucce.js";
import { t as formatCliCommand } from "./command-format-3Z_Kl5PP.js";
import { r as buildWorkspaceSkillSnapshot } from "./skills-CZKYRFRI.js";
import { r as normalizeChannelId, t as getChannelPlugin } from "./plugins-Csb211Yn.js";
import { l as resolveStorePath } from "./paths-DBVuZIGo.js";
import { d as deriveSessionTotalTokens, f as hasNonzeroUsage } from "./session-cost-usage-BlB91_zm.js";
