...
├── lib/
│   ├── types/
│   │   └── task-REDACTED.ts      # 类型定义
│   ├── utils/
│   │   └── task-REDACTED.ts      # 工具函数
│   ├── store/
...
```tsx
import { useTasksStore } from '@/lib/store/tasks-store';
import { sortTasks, getTaskStats } from '@/lib/utils/task-REDACTED';
...
```tsx
import { useTasksStore } from '@/lib/store/tasks-store';
import { validateTaskData } from '@/lib/utils/task-REDACTED';
...
```tsx
import { useTasksStore } from '@/lib/store/tasks-store';
import { filterTasksByType, filterTasksByStatus, sortTasks } from '@/lib/utils/task-REDACTED';
...
```tsx
import { useTasksStore } from '@/lib/store/tasks-store';
import { getRoleForTaskType, AI_MEMBER_ROLES } from '@/lib/types/task-REDACTED';
