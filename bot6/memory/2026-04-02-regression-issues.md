...
**lib/mcp/**tests**/enhancement.test.ts** (多处)
...
**中优先级**: 5. `RoomManager.test.tsx` - 测试文件类型错误 6. `mcp/__tests__/enhancement.test.ts` - StreamingContext 类型不匹配

**低优先级**: 7. CSS 优化警告 - 不影响功能 8. Next.js 配置警告 - 需要更新配置
