...
console.log('检查前 10 个市场（find accepting_orders: true）');
console.log('='.repeat(70));
...
async function main() {
  console.log('🦞 Polymarket 工程验证模式 - 检查前 10 个市场\n');
  ...
  if (result.success) {
    ...
    console.log('\n❌ 未找到有效市场');
    console.log('\n建议:');
    console.log('  1. 检查更多市场（前 50 个）');
    console.log('  2. 降低价格限制（允许 0.50 - 0.99）');
