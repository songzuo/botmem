...
| # | Provider | 端点 | Key | 模型 |
|---|----------|------|-----|------|
| 1 | volcengine-2 | ark.cn-beijing.volces.com/api/coding | 4e051cf9-... | doubao-seed-code |
| 2 | volcengine | ark.cn-beijing.volces.com/api/coding | aab2bcb7-... | doubao-seed-code |
| 3 | volcengine-3 | ark.cn-beijing.volces.com/api/coding | cc2edbb6-... | doubao-seed-code |
| 4 | alibaba | coding.dashscope.aliyuncs.com | sk-sp-3657... | qwen3.5-plus |
| 5 | bailian2 | coding.dashscope.aliyuncs.com | sk-sp-4d4f... | qwen3.5-plus |
| 6 | alibaba-2 | coding.dashscope.aliyuncs.com | sk-sp-4d4f... | qwen-turbo |
...
- `4e051cf9-b27b-41eb-9540-2890ad94a271` (volcengine-2)
- `aab2bcb7-753d-4d59-8f6c-91953feec979` (volcengine)
- `cc2edbb6-ceec-4702-aaf1-011ca035f3f4` (volcengine-3)

### Alibaba (Coding Plan - 优惠)
- `sk-sp-365714cef25a45df8e9b3948641695e6` (alibaba)
- `sk-sp-4d4f86d364934d48b80423f72b5495d1` (bailian2, alibaba-2)

### NewCLI (共享Key)
- `sk-ant-oat01-FLSPC7gvHvAn7sKUcwxXo5RVdNGwU_apQ6fQO3w72OPPbPN21rxo4w9EcGgRXkWsjfP4vEKHfflenh5hJROSdJYKi7K9qAA`

### 其他
- SiliconFlow: `sk-tkzfpovkbzxpumqpnxsecrqzkjdythmlqgecbljqzhrfehwa`
- Qiniu: `sk-67421f9e478a7ee81fa98ea06a5bceda4958db419dec37c432057916f4b05961`
- MiniMax: `sk-cp--HJ367Hzkp0OAqaY88Wzzcxp1Z9VSdMi7HDiWzp78sdqrnIXH9nmNVuoGiiHxpyoS0PSzb_V5R31ZEchtAGTODFDfGeR-xk8eW_I2GLxvDOotOh7Bjc1QA8`
